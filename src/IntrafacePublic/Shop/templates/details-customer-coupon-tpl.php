...
<fieldset id="details-customer-coupon" class="details-customer">
    <legend><?php e(__('Customer coupon')); ?></legend>
    <p><?php e(__('If you have any promotion coupon, please fill it in here.')); ?></p>
    <div class="row">
        <label for="customer_coupon"><?php e(__('Customer coupon')); ?></label>
